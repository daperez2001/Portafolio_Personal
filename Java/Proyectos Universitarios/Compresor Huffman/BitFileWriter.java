 ...
 */
   private void writeHeader() {
      ...
      lastHeaderByte.append(String.format("%1$" + 3 + "s", Integer.toString(this.stuffBits, 2)).replace(' ', '0'));
 ...
 */
    ...
    public static final void main( String [] args ) {
       BitFileWriter bits = new BitFileWriter("testProfe.ext.huf", 7);
       bits.write("11100110100000110010100110111100110110000000111010000000");
       bits.close();
    }
